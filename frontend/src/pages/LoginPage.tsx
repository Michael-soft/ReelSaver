    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {mode === 'register' && (
            <p style={{ fontSize: '0.75rem', color: 'var(--muted)', textAlign: 'center', margin: 0, lineHeight: 1.5 }}>
              By creating an account you agree to our{' '}
              <Link to="/terms" style={{ color: 'var(--accent-light)' }}>Terms of Service</Link>{' '}
              and{' '}
              <Link to="/privacy" style={{ color: 'var(--accent-light)' }}>Privacy Policy</Link>.
            </p>
          )}
        </div>
      </div>
